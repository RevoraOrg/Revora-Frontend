...
export const TOKEN_GROUPS: TokenGroup[] = [
  {
    ...
    tokens: [
      ...
      { name: "Chart Tooltip BG", variable: "--chart-tooltip-bg", value: "#0f172a", description: "Slate 900 - tooltip surface layered above the #020617 chart surface" },
      { name: "Chart Tooltip FG", variable: "--chart-tooltip-fg", value: "#f8fafc", description: "Slate 50 - 17.1:1 WCAG AA/AAA on --chart-tooltip-bg (WCAG 1.4.3)" },
      { name: "Chart Tooltip Border", variable: "--chart-tooltip-border", value: "#64748b", description: "Slate 500 - 3.75:1 non-text contrast on tooltip bg (WCAG 1.4.11)" },
      { name: "Chart Axis Label", variable: "--chart-axis-label-color", value: "#94a3b8", description: "Slate 400 - 7.87:1 WCAG AA on #020617 (>= 4.5:1 small text)" },
  ...
  },
  {
    ...
    tokens: [
      ...
      { name: "Chart Axis Size", variable: "--chart-axis-label-size", value: "0.75rem", description: "12px base size for axis text, fluid with user zoom (WCAG 1.4.4)" },
      { name: "Chart Axis Weight", variable: "--chart-axis-label-weight", value: "500", description: "Medium weight keeps small axis text legible on dark surfaces" },
