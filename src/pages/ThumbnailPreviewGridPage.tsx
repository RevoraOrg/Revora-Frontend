...
export const ThumbnailPreviewGridPage: React.FC = () => {
    ...
    <div className="min-h-screen p-6 md:p-10 animate-fade-in">
      <div className="max-w-[1100px] mx-auto">
        <header className="mb-8">
          <Link to="/startup/distributions" className="text-sm text-muted hover:text-main transition-colors mb-4 inline-block">
            &larr; Back to Distribution Dashboard
          </Link>
